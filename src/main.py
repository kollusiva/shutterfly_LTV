...
class CustomerInfo(object):
    ...
    # Constructor to map the order ID and amount
...
# Ingest the coming event to CustomerInfo & TimeFrame
def ingest(event, D):
    customer_map, tf = D
...
def main():
    ...
    # Create a hash map to direct customer_id to CustomerInfo object
    customer_map = dict()
